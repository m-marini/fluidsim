...
public class ActionHandler {
	...
	JMenu menu = new JMenu(Messages
		.getString("ActionHandler.fileMenu.text")); //$NON-NLS-1$
	...
	action.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(value)); //$NON-NLS-1$
