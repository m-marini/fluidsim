...
public class Utils {
	 ...
	 */
	public static int transformToColumn(final Universe universe, final double x, final double y) {
	 ...
	 * @return the column index
	 */
	public static int transformToColumn(final Universe universe, int x, final int y) {
		if ((y % 2) == 1) {
			--x;
		}
	 ...
	 */
	public static int transformToRow(final Universe universe, final double x, final double y) {
		final int gx = transformToX(universe, x, y);
	 ...
	 * @return the row index
	 */
	public static int transformToRow(final Universe universe, final int x, final int y) {
		return y;
	}
	 ...
	 * @return the x coordinate
	 */
	public static int transformToX(final Universe universe, final double x, final double y) {
	 ...
	 * @return the y coordinate
	 */
	public static int transformToY(final Universe universe, final double x, final double y) {
		final Dimension size = universe.getSize();
