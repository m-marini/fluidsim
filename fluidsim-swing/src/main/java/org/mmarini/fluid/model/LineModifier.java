...
public class LineModifier extends AbstractUniverseModifier {
	 ...
	 * @param y1
	 */
	public LineModifier(final CellModifier cellModifier, final double x0,
	 ...
	 */
	private void modifyHorizontallyDown(final Universe universe, final int x0,
	 ...
	 *            the y1 right upper row
	 */
	private void modifyHorizontallyUp(final Universe universe, final int x0,
			final int y0, final int x1, final int y1) {
		final int i0 = Utils.transformToRow(universe, x0, y0);
		final int j0 = Utils.transformToColumn(universe, x0, y0);
		final int j1 = Utils.transformToColumn(universe, x1, y1);
	 ...
	 *            the y upper corner
	 */
	private void modifyVertically(final Universe universe, final int x0,
			final int y0, final int x1, final int y1) {
		final int i0 = Utils.transformToRow(universe, x0, y0);
		final int j0 = Utils.transformToColumn(universe, x0, y0);
